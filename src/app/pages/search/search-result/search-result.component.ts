  ...
  searchResults: SearchResult[] = [
    {
      ...
      description:
        "Challenging trek to the world's third highest mountain with breathtaking Himalayan views.",
      image:
        'https://images.unsplash.com/photo-1452570053594-1b985d6ea890?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
      rating: 4.9,
      location: 'Gangtok',
      duration: '7 days',
    ...
    },
    {
      ...
      description:
        'Serene high-altitude lake with yak rides and stunning mountain reflections.',
      image:
        'https://images.unsplash.com/photo-1566438480900-0609be27a4be?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
      rating: 4.7,
      location: 'Gangtok',
      duration: '1 day',
    ...
    },
    {
      ...
      description:
        "Explore one of Sikkim's most important Buddhist monasteries with golden stupas.",
      image:
        'https://images.unsplash.com/photo-1513415277900-a62401e19be4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
      rating: 4.8,
      location: 'Gangtok',
      duration: 'Half day',
    ...
    },
    {
      ...
      description:
        'Panoramic sunrise views over Kanchenjunga range with coffee service.',
      image:
        'https://images.unsplash.com/photo-1509316785289-025f5b8b7393?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
      rating: 4.6,
      location: 'Gangtok',
      duration: '2 hours',
    ...
    },
    {
      ...
      description:
        'Guided tour through local markets, temples and colonial landmarks.',
      image:
        'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
      rating: 4.5,
      location: 'Gangtok',
      duration: '1 day',
    ...
    },
    {
      ...
      description:
        'Springtime walk through vibrant rhododendron forests with birdwatching.',
      image:
    ...
    if (filters.durations.size > 0) {
      results = results.filter((result) => {
        ...
        return Array.from(filters.durations).some((selectedDuration) => {
          if (selectedDuration === '0-3')
            return duration.includes('hour') || duration.includes('half day');
          if (selectedDuration === '3-6')
            return duration.includes('hours') || duration.includes('half day');
          if (selectedDuration === '1-day')
            return duration.includes('day') && !duration.includes('days');
          if (selectedDuration === '2-3-days')
            return duration.includes('days') && !duration.includes('4+');
          if (selectedDuration === '4-plus')
            return duration.includes('days') || duration.includes('week');
          return false;
        });
      });
    }
