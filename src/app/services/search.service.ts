...
export class SearchService {
  ...
  sortResults(results: ResultItem[], sort: string): ResultItem[] {
    ...
    if (sort === 'popularity') {
      ...
      return [...results].sort((a, b) => (b.popularityIndex ?? 0) - (a.popularityIndex ?? 0));
    }
  ...
  getDestinations() {
    return [
      ...
      },
      {
        "id": 7,
        "title": "Nathula Pass",
        "description": "High-altitude pass connecting India with China, offering scenic views of the Himalayan range.",
      ...
      },
      {
        "id": 8,
        "title": "Mangan Valley",
        "description": "A peaceful valley known for its lush green landscapes, perfect for trekking and exploration.",
